...
import com.musifyimtiaz.app.ui.component.LyricsBackgroundType
import com.musifyimtiaz.app.ui.component.LyricsCardConfig
import com.musifyimtiaz.app.ui.component.LyricsGlassStyle
import com.musifyimtiaz.app.ui.component.LyricsLayoutStyle
    ...
    fun saveBitmapAsFile(context: Context, bitmap: Bitmap, fileName: String): Uri {
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            val contentValues = ContentValues().apply {
                ...
                put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/Musify")
            }
