...
import com.musifyimtiaz.app.constants.QueueEditLockKey
...
import com.musifyimtiaz.app.extensions.toggleRepeatMode
...
import com.musifyimtiaz.app.ui.component.MediaMetadataListItem
import com.musifyimtiaz.app.ui.menu.PlayerMenu
import com.musifyimtiaz.app.ui.menu.SelectionMediaMetadataMenu
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is com.musifyimtiaz.app.together.TogetherSessionState.Joined &&
                (togetherSessionState as com.musifyimtiaz.app.together.TogetherSessionState.Joined).role is com.musifyimtiaz.app.together.TogetherRole.Guest
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? com.musifyimtiaz.app.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is com.musifyimtiaz.app.together.TogetherRole.Guest
                                                                if (isGuest) {
