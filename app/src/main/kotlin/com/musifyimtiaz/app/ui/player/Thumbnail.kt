...
import com.musifyimtiaz.app.canvas.OpenTuneCanvas
import com.musifyimtiaz.app.canvas.CanvasArtwork
...
import com.musifyimtiaz.app.constants.PlayerHorizontalPadding
...
import com.musifyimtiaz.app.constants.MaxCanvasCacheSizeKey
...
fun Thumbnail(
    ...
    LaunchedEffect(itemScrollOffset) {
        ...
        if (currentItem > currentMediaIndex && canSkipNext) {
            ...
            if (com.musifyimtiaz.app.ui.screens.settings.DiscordPresenceManager.isRunning()) {
                try { com.musifyimtiaz.app.ui.screens.settings.DiscordPresenceManager.restart() } catch (_: Exception) {}
            }
