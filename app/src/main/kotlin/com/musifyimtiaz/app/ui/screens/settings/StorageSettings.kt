...
import com.musifyimtiaz.app.constants.MaxImageCacheSizeKey
...
import com.musifyimtiaz.app.extensions.tryOrNull
import com.musifyimtiaz.app.ui.component.ActionPromptDialog
...
import com.musifyimtiaz.app.ui.player.CanvasArtworkPlaybackCache
import com.musifyimtiaz.app.ui.utils.backToMain
import com.musifyimtiaz.app.ui.utils.formatFileSize
    ...
    LaunchedEffect(maxImageCacheSize) {
        if (maxImageCacheSize == 0) {
            coroutineScope.launch(Dispatchers.IO) {
                ...
                com.musifyimtiaz.app.utils.ArtworkStorage.clear(context)
            }
        }
    }
