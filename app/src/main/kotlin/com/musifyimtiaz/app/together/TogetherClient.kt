...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: com.musifyimtiaz.app.together.JoinDecision,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: com.musifyimtiaz.app.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is com.musifyimtiaz.app.together.JoinDecision -> {
